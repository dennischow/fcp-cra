                            ...
                            <section className="profile-group">
                                <div className="profile-group__container">
                                    ...
                                    <div className="profile-group__content">
                                        ...
                                        <p className="profile-group__text">In the past years, I have been on and off self-experimenting with AngularJS, Vue, ReactJS, Gatsby, Meteor, C3, Chart, Moment, BEM, jsRender, Handlebar, Jade/Pug, Nunjucks, and Craft, trying to have them under my belt.</p>
